            ...
            <div class="breadcrumb-gs">
                ...
                if ($sub_actual) {
                    ...
                    foreach ($dirs as $d) {
                        ...
                        $url = '?ver_cliente=' . urlencode($ver_cliente)
                            . '&dir=' . urlencode(rtrim($acc, '/'))
                            . ($ver_auditar ? '&auditar=1' : '');

                        echo " / <a href='{$url}'>" . esc_html($d_limpio) . "</a>";
     ...
     <style>
        #tablaArchivos thead th {
            ...
            @media (max-width: 600px) {
                ...
                /* Más específico que td — oculta la fecha de escritorio */
