...
### PASO 2: Copiar archivos en sus ubicaciones

**Archivo principal:**
- `01-intranet-gestoria-ACTUALIZADO.php` → `intranet-gestoria.php` (en raíz)
...
**Client (en src/Client/):**
- 09-ClientManager.php
- 10-ClientUI.php
- 11-ClientActions.php
